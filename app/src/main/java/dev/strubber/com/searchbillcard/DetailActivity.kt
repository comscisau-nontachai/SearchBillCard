        ...
        override fun onPostExecute(result: String?) {
            ...
            for (item in listProductProcess) {
                when (item.department) {
                    ...
                    "2" -> {
                        recycler_view_dep2.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(applicationContext)
                    ...
                    "3" -> {
                        recycler_view_dep3.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(applicationContext)
                    ...
                    "4" -> {
                        recycler_view_dep4.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(applicationContext)
...
//        1000                                          -> finish1
    ...
    inner class RvDep1Adapter(private val context: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            return ViewHolder(LayoutInflater.from(this@DetailActivity).inflate(R.layout.item_process_product, parent, false))
        }
    ...
    inner class RvDep2Adapter(private val context: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<ViewHolder>() {
    ...
    inner class RvDep3Adapter(private val context: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<ViewHolder>() {
    ...
    inner class RvDep4Adapter(private val context: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<ViewHolder>() {
